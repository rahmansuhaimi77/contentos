...
const ideas: readonly BetaIdea[] = [
  ['Public · Main Recruitment', 'Beta testers wanted — IIUM Gombak.', 'PUBLIC ANONYMOUS RECRUITMENT. Invite 20 passenger testers and 10 student-driver testers for a new campus transport coordination app. Do not use the KampusRide name, logo, screenshots or identifying product details. State clearly that this is a guided simulation only.', 'Message the admin to join. Limited slots.'],
